...
-- Wymagane, żeby zmiana awatara (users.avatar_url) była widoczna na żywo u innych użytkowników,
-- bez odświeżania strony (patrz ChatApp.subscribeToProfileUpdates w chat.js).
